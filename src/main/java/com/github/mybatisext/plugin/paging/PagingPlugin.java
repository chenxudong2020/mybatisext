...
import com.github.mybatisext.MapperProxyExt;
...
import com.github.mybatisext.interceptor.MyBatisInvocation;
...
public class PagingPlugin implements Interceptor {
	...
	public void setDialect( DialectSQL dialect ) {
	...
	protected String getCountSql( String sqlPrimary ) {
		if ( getDialect() != null ) {
			return getDialect().getPagingCountSQL(sqlPrimary);
		}
