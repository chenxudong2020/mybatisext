...
import com.github.mybatisext.activerecord.proxy.TableProxy;
import com.github.mybatisext.activerecord.proxy.TransactionHolder;
...
import com.github.mybatisext.helper.PropertyHelper;
...
public class DBImpl implements DB {
	...
	public <TABLE, ID> Table<TABLE, ID> active(String name, Class<TABLE> tableType, String idField, Class<ID> idType) {
		Table<TABLE, ID> table = (Table<TABLE, ID>) tableCache.get(name);
		if (table != null) {
			return table;
		}
